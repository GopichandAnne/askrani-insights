-- ═══════════════════════════════════════════════════════════════════════
-- local-intel — complete database setup (paste into Supabase SQL Editor)
-- Runs: core schema (0001) → RLS (0002) → collection jobs (0003) → seed
-- Safe on a fresh project. Re-running errors on existing objects (expected).
-- ═══════════════════════════════════════════════════════════════════════
