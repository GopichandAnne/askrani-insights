...
const COMMANDS: Command[] = [
  ...
  { label: "Market report", href: "/reports", icon: "📊", hint: "Full report · export · cost", keywords: ["report", "export", "pdf", "excel", "xlsx", "spreadsheet", "download", "summary", "monitoring cost", "spend", "budget"] },
