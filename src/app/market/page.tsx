...
export default async function MarketPage() {
  ...
  const cards = [
    ...
    { href: "/offers", icon: "💸", title: "Offers & prices", desc: area
      ? "Item prices side by side across the area — who's cheapest item-by-item and where the price bands sit."
      : "Item prices side by side: your price positioning vs rivals, and who's cheapest item-by-item." },
